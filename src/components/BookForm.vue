<template>
  <div class="flex justify-center mt-10">
    <form @submit.prevent="onSubmit" class="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
      ...
      <div class="mb-4">
        ...
        <input v-model="book.bookname" type="text" class="border rounded w-full p-2" required />
      </div>

      <div class="mb-4">
        <label class="block text-gray-700">Author</label>
        <input v-model="book.author" type="text" class="border rounded w-full p-2" required />
      </div>

      <div class="mb-4">
        <label class="block text-gray-700">Quantity</label>
        <input v-model="book.quantity" type="number" class="border rounded w-full p-2" required />
      </div>

      <div class="mb-4">
        <label class="block text-gray-700">Price</label>
        <input v-model="book.price" type="number" class="border rounded w-full p-2" required />
      </div>
